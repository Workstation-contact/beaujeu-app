...
import { useGLTF, useAnimations, OrbitControls, Environment, ContactShadows, Plane, useProgress, Html, PresentationControls } from '@react-three/drei'
...
function Model({ ...props }: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials, animations } = useGLTF('/obj7.glb') as GLTFResult
...
export default function Rock(){
  ...
  return(
    ...
    <OrbitControls makeDefault minPolarAngle={0} maxPolarAngle={Math.PI / 1.75} zoomSpeed={.8} />
      <hemisphereLight
